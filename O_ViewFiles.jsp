...
try 
	{		
				...
				%>
            <tr>
              <td width="53" height="30" bgcolor="#FF0000"><div align="center" class="style23"> ID </div></td>
              <td width="115" bgcolor="#FF0000"><div align="center" class="style23">File Name </div></td>
              <td width="284" bgcolor="#FF0000"><div align="center" class="style23">Digital Sign </div></td>
              <td width="127" bgcolor="#FF0000"><div align="center" class="style23">View </div></td>
            </tr>
            <%
            ...
            <tr>
              ...
              <td><div align="center" class="style24"><a href="O_FileDetails.jsp?usid=<%=i%>">View More ...</a></div></td>
            </tr>
            <%
