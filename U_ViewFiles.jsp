    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View Files </h2>
          <p class="infopost">&nbsp;</p>
          <table width="460" border="1.5" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <%	  
...
try 
	{		
				...
				%>
            <tr>
              <td width="72" height="30" bgcolor="#FF0000"><div align="center" class="style21 style31"><strong> ID </strong></div></td>
              <td width="138" bgcolor="#FF0000"><div align="center" class="style32">File Name </div></td>
              <td width="242" bgcolor="#FF0000"><div align="center" class="style32">Data Owner </div></td>
              <td width="242" bgcolor="#FF0000"><div align="center" class="style32">Document Tag </div></td>
              <td width="242" bgcolor="#FF0000"><div align="center" class="style32">Document Uses </div></td>
            </tr>
            <%
            ...
            <tr>
              ...
              <td><div align="center" class="style33"><%=s5%></div></td>
            </tr>
            <%
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="U_Search.jsp">Search Query</a></li>
