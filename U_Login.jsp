      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form action="U_Authentication.jsp" method="post" id="leavereply">
            ...
            <span class="style10">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Name (required)</span></span><span class="style10">&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></label>
            <span class="style10">
            ...
            <p align="center"><span class="style8">New Data Users? click here to <a href="U_Register.jsp"> Register</a></span></p>
            <p align="center">&nbsp;</p>
          </form>
          <div class="clr"></div>
          <div class="clr"></div>
