...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View and Authorize Owners !!! </h2>
          <p class="infopost">&nbsp;</p>
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              <td width="108" height="30" bgcolor="#FF0000"><div align="center" class="style9 style34"><strong> ID </strong></div></td>
              <td width="183" bgcolor="#FF0000"><div align="center" class="style35">Data Owner  Name </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              <td height="28"><div align="center" class="style37"><%=i%></div></td>
              <td><div align="center" class="style37"><a href="DE_OwnerDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
              <%	
			if(s5.equalsIgnoreCase("Waiting"))
			{
			
		%>
              <td><div class="style37">
                  <div align="center"><a href="DE_StatusOwner.jsp?id=<%=i%>"><%=s5%></a></div>
              </div></td>
              <%
