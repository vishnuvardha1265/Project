...
.style30 {font-size: 14px; color: #FFFF00; font-weight: bold; }
-->
</style>
</head>
<body>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form action="U_Request_Key1.jsp" method="post" name="form1" id="form1">
            <p>&nbsp;</p>
            <table width="524" border="1" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td width="223" height="37" bgcolor="#FF0000"><span class="style30">Enter File Name :</span></td>
                <td width="245"><label>
                  <input required="required" name="fname" type="text" size="40" />
                </label></td>
              </tr>
              <tr>
                <td height="38" bgcolor="#FF0000"><span class="style30">Enter File Owner: </span></td>
                <td><input name="fowner" type="text" size="40" /></td>
              </tr>
              <tr>
                <td height="43"><div align="right">
                    <input type="submit" name="Submit" value="Req Secret Key" />
                </div></td>
                <td>&nbsp;</td>
              </tr>
            </table>
