...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style31">Data Users::</span> <%=application.getAttribute("uname")%> !!</h2>
          <p class="infopost">&nbsp;</p>
          <p class="infopost"><img src="images/user1.gif" width="466" height="244" /></p>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="U_Search.jsp">Search Dcocuments </a></li>
            <li><a href="U_ViewFiles.jsp">View Files</a></li>
			 <li><a href="U_Request_Key.jsp">Request Secret Key</a></li>
