...
<head>
<title>CS_View_Data_Transanctions</title>
...
try 
	{		
				...
				%>
            <tr>
              <td width="53" height="30" bgcolor="#FF0000"><div align="center" class="style9 style23"><strong> ID </strong></div></td>
              <td width="115" bgcolor="#FF0000"><div align="center" class="style24">Username </div></td>
              <td width="284" bgcolor="#FF0000"><div align="center" class="style24">Filename </div></td>
			    <td width="284" bgcolor="#FF0000"><div align="center" class="style24">Task </div></td>
              <td width="127" bgcolor="#FF0000"><div align="center" class="style24">Date and Time</div></td>
            </tr>
            <%
