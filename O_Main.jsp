...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style6">Data Sender ::</span>  <%=application.getAttribute("doname")%> !!</h2>
          <p class="infopost">&nbsp;</p>
          <p class="infopost"><img src="images/Dataowner.gif" width="637" height="267" /></p>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="O_Update.jsp">Update</a></li>
            <li><a href="O_Delete.jsp">Delete</a></li>
            <li><a href="O_ViewFiles.jsp">View Files</a></li>
			<li><a href="O_View_Secret_Key_Request.jsp">View Secret Key Request</a></li>
